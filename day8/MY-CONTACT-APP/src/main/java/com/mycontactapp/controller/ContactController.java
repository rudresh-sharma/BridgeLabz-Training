...
public class ContactController {
    ...
    public ResponseEntity<ContactResponseDTO> makeFavourite(@PathVariable("id") Long id ){
    	
    	ContactResponseDTO res = contactService.madeAFavourite(id);
    ...
    @Operation(
    		summary = "Removing from favourite",
    		description = "Just removing from favourite")
    @ApiResponse(
    	    responseCode = "200",
    	    description = "Favourite contact successfully removed"
    	)
    @DeleteMapping("/{id}/favourite")
    public ResponseEntity<ContactResponseDTO> removeFavourite(@PathVariable("id") Long id ){
    	
    	ContactResponseDTO res = contactService.removeAFavourite(id);
    ...
    @Operation(
    	    ...
    	    description = "Retrieves all contacts marked as favourite"
    	)
    	@ApiResponse(
    	    responseCode = "200",
    	...
    	public ResponseEntity<List<ContactResponseDTO>> getAllFavourites() {

    	    List<ContactResponseDTO> response =
    	            contactService.getAllFavourites();
