package com.functionalinterfaces.implementinginterfaces.digitalpayment;
...
public class DigitalPaymentApp {
    public static void main(String[] args) {
        ...
        PaymentProcessor upi = new UpiPayment("rudresh@upi");
        PaymentProcessor creditCard = new CreditCardPayment("1234567890123456", "Rudresh Sharma");
